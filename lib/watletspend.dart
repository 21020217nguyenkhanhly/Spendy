...
import 'watletincome.dart';
import 'qr.dart';

class WatletSpendPage extends StatefulWidget {
  @override
  _WatletSpendPageState createState() => _WatletSpendPageState();
}

class _WatletSpendPageState extends State<WatletSpendPage> {
  String _selectedOption = "Chi tiêu"; // Mặc định là Chi tiêu
                              ...
                              ListTile(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => WatletIncomePage(),
                                    ),
                                  );
                                },
                              ),
                          ...
                          children: [
                            ...
                            if (_moneyController.text.isNotEmpty)
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize: 30, color: Color(0xFFEB0101)),
                              ),
                          ],
                        ),
                      ],
